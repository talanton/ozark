...
const GET_STARTED_CARDS = [
  {
    ...
    text: 'We combine our own quantitative models with open source applications.',
    link: {
      text: 'Go to GitHub',
      href: 'https://github.com/taltec',
    },
  },
  {
    icon: BuildingIcon,
    title: 'Start Building',
    text: 'Full support with rapid response from our quantitative developers.',
    link: {
      text: 'Our Services',
  ...
  },
  {
    ...
    text: 'Rapid, scalable and cost effective analytics.',
    link: {
      text: 'Get Access',

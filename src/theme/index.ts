...
const gradients = {
  primary: 'linear-gradient(142.21deg, #000090 4.44%, #000090 94.64%)',
  secondary: 'linear-gradient(296.58deg, #000090 -6.45%, #000090 96.92%)',
  tertiary: 'linear-gradient(180deg, rgba(79, 218, 184, 0) 20.47%, #000000 102.84%)',
};
...
const themeExtension = {
  ...
  fonts: {
    ...
    blogPostBody: `${fontFamily.inter}, ${base.fonts.body}`,
  },
  components,
  breakpoints,
  colors,
